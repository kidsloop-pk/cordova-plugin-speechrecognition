...
public class Speech extends CordovaPlugin {
    ...
    private boolean offlineRecognitionRequired = false;
    ...
    private void startRecognition(boolean partialResultRequired, boolean offlineRecognitionRequired, CallbackContext callbackContext) {
        ...
        this.offlineRecognitionRequired = offlineRecognitionRequired;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
...
//        this.speechRecognizer.setRecognitionListener(new SpeechRecognizationListener());
        ...
        recognizerIntent.putExtra("android.speech.extra.DICTATION_MODE", partialResultRequired);
                ...
                try {
                    ...
                    if (matches != null) {
                        try {
                            ...
                            PluginResult pluginResult = new PluginResult(PluginResult.Status.OK, jsonObject);
                            pluginResult.setKeepCallback(true);
                            this.sttCallbackContext.sendPluginResult(pluginResult);
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
                    }
                    ...
                    e.printStackTrace();
                    this.sttCallbackContext.error(e.getMessage());
                }
            } else {
                this.sttCallbackContext.error(Integer.toString(resultCode));
            }
            return;
        }
    ...
    private class SpeechRecognizationListener implements RecognitionListener {
        @Override
        ...
        public void onError(int errorCode) {
            ...
            sttCallbackContext.error(error);
            speechRecognizer.destroy();
        }
        ...
        public void onResults(Bundle finalResults) {
            ...
            if (matches != null) {
                try {
                    ...
                    sttCallbackContext.sendPluginResult(pluginResult);
                    speechRecognizer.destroy();
                } catch (JSONException e) {
                    e.printStackTrace();
                }
